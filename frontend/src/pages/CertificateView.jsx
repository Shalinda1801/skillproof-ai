...
const CertificateView = () => {
    ...
    const loadCertificate = async () => {
      try {
        ...
        const [
          ...
          certificateApi.verifyCertificate(
            certificateId
          ),
        ...
        const myCertificates =
          myCertificatesResponse.certificates ||
          [];
  ...
  const verifyUrl =
    `${clientUrl}/verify/${certificateId}`;
  ...
  const handleDownloadPdf = async () => {
    try {
      ...
      alert(
        "PDF download failed. Check browser console."
      );
    } finally {
  ...
  if (loading) {
    return (
      <>
        ...
        <main className="relative z-10 grid min-h-screen place-items-center px-6 text-slate-900">
        ...
        <main className="relative z-10 grid min-h-screen place-items-center px-6 text-slate-900">
          <div className="glass-card rounded-[2rem] p-8 text-center">
            ...
            <Link
              ...
              className="primary-btn mt-6 inline-flex"
            >
              Back to Dashboard
            </Link>
          </div>
  ...
  if (!isPaid) {
    return (
      <>
        ...
        <main className="relative z-10 grid min-h-screen place-items-center px-6 py-10 text-slate-900">
          <section className="glass-card pro-card max-w-2xl rounded-[2rem] p-8 text-center">
            <div className="mx-auto grid h-20 w-20 place-items-center rounded-3xl border border-amber-200 bg-amber-50 text-amber-700">
              <AlertTriangle
                size={42}
              />
            </div>
            ...
            <p className="mt-4 leading-7 text-slate-600">
              ...
              approved, but certificate view
              and PDF download are locked
              until the certificate payment
              is completed.
            </p>

            <div className="mt-6 rounded-3xl border border-slate-200 bg-slate-50 p-5 text-left">
  ...
  return (
    <>
      ...
      <main className="relative z-10 min-h-screen px-6 py-8 text-slate-900">
        <div className="mx-auto max-w-7xl">
          <div className="no-print mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <Link
              to="/student/dashboard"
              className="inline-flex items-center gap-2 text-sm font-bold text-slate-700 hover:text-indigo-700"
            >
              <ArrowLeft size={17} />
              ...
              <div className="certificate-inner-border">
                <div className="relative z-10 flex items-start justify-between gap-6">
                  <div className="flex items-center gap-4">
                    <div className="grid h-16 w-16 place-items-center rounded-2xl bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-600 text-white">
                      <ShieldCheck
                        size={34}
                      />
                    </div>
                ...
                <div className="mt-10 text-center">
                  <p className="text-sm font-black uppercase tracking-[0.55em] text-indigo-700">
                    Certificate of Achievement
                  </p>
                  ...
                  <div className="mx-auto mt-5 h-1 w-40 rounded-full bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600" />
                  ...
                  <p className="mx-auto mt-7 max-w-4xl text-lg leading-8 text-slate-600">
                    ...
                    project skills and completing
                    the verification process for
                  </p>

                  <h2 className="mt-6 text-4xl font-black text-indigo-700">
                    {certificate.skill?.title ||
                      "Skill Certificate"}
                  </h2>
                </div>
                ...
                <div className="mt-10 grid gap-5 md:grid-cols-4">
                  ...
                  <div className="certificate-info-box">
                    <Award className="mb-3 text-violet-700" />
                ...
                <div className="mt-10 grid gap-8 md:grid-cols-[1fr_220px] md:items-end">
                  <div>
                    <div className="rounded-3xl border border-slate-300 bg-white/70 p-6">
                      ...
                      <p className="mt-3 break-all text-sm font-semibold text-indigo-700">
                        {verifyUrl}
                      </p>
                    </div>
                ...
                <div className="mt-8 flex items-center justify-between border-t border-slate-300 pt-5 text-xs font-semibold text-slate-500">
                  <p>
                    ...
                    verified online using the QR
                    code or certificate ID.
                  </p>
