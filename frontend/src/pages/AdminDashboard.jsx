...
const AdminDashboard = () => {
  ...
  const statCards = [
    ...
    {
      title: "AI Reviewed",
      value: submissions.filter((item) => item.status === "AI_REVIEWED").length,
      icon: Brain,
    },
    {
      title: "Approved",
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="glass-card rounded-[2rem] p-8">
          ...
          <h1 className="mt-3 text-4xl font-black">
            Welcome {user?.name}, review skill evidence with confidence.
          </h1>
          <p className="mt-4 max-w-3xl text-slate-400">
            Manage submissions, AI assessment, approval workflow, and
            QR-verified certificates from one dashboard.
          </p>
        </section>
